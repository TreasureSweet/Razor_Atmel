...
#define ANT_DEVICEID_DEC_USERAPP        (u8)1024
#define ANT_DEVICEID_LO_USERAPP         (u8)0x00              // Low byte of two-byte Device #
#define ANT_DEVICEID_HI_USERAPP         (u8)0x04              // High byte of two-byte Device #
...
#define TestTimes (u8)30                                      // default HR test times
/**********************************************************************************************************************
